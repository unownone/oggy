...
export default defineUnlistedScript(() => {
  ...
  // on the next task so waitForHello does not fall through to the 2s timeout.
...
function bootPolyfill(): void {
  try {
    ...
    console.warn("[oggy] WebMCP polyfill failed to initialize:", err);
  }
}
